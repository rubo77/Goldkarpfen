...
if ! python3 -c "import stem" > /dev/null 2>&1 || ! command -v python3 > /dev/null 2>&1;then >&2 echo "  II python-stem and/or python3 not found (ignore this if you are running i2p only or tor-static)";echo "$RE";exit;fi
